...
public class DeviceControlActivity extends Activity {
	...
	private final ExpandableListView.OnChildClickListener servicesListClickListner = new ExpandableListView.OnChildClickListener() {
		...
		public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
			if (mGattCharacteristics != null) {
				...
				Log.d(TAG, "charactersitic PROPERTY_READ: " + ((charaProp | BluetoothGattCharacteristic.PROPERTY_READ) > 0) + ", PROPERTY_NOTIFY: "
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			return true;
		case R.id.menu_plot:
			final Intent intent = new Intent(this, DataPlotActivity.class);
			intent.putExtra(DataPlotActivity.EXTRAS_DEVICE_NAME, mDeviceName);
			intent.putExtra(DataPlotActivity.EXTRAS_DEVICE_ADDRESS, mDeviceAddress);
	...
	private void displayData(String data) {
		if (data != null) {
			mDataField.setText(Html.fromHtml(data));
		} else {
			mDataField.setText(Html.fromHtml("<small><i>(null)</i></small>"));
		}
	}
