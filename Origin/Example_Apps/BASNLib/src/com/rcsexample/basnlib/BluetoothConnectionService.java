 ...
 * a listener.
 * <p>
 * A reference to an object of this class is also used in the {@link DataProvider} class to receive the raw data from a
 * bluetooth sensor and pass it to decoding.
 * <p>
